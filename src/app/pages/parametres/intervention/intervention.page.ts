...
initAddUserForm() {
  this.form = new FormGroup({
   ...
   password:  new FormControl(null, [Validators.required, Validators.minLength(6)]),
    ...
    entrepriseId:  new FormControl(this.InterventionService.entrepriseId,[]),
 });
}
...
async submit(postData: any) {
  ...
  if(this.role == 'update') {
   /**
    *  this.InterventionService.update(this.form.value).subscribe((res) => {
      loading.dismiss();
      console.log(res)
if(res['success'] == true) {
  ...
  this.toastController.presentToast(res['message']);
    ...
    */
    ...
    this.InterventionService.post(this.form.value).subscribe((res) => {
      console.log(res)
      loading.dismiss();
...
delete() {
  this.InterventionService.delete(4)
  .subscribe( data => {
